<?php
/*
Template Name: bochka
*/
get_header();
?>
<div class="service__block-fitobochka">
    <div class="container">
...
<div class="popup_fitobochka" style="display: none;">
    <div class="popup_container">
        <a class="close__popup">X</a>
        <form id="popup_service">
            <input type="hidden" name="name_service" value="Фитобочка">
